...
- [x] Mention two parts of Express that you learned about this week.
    I learned that Express is simple, unopinionated, extensible, and lightweight. Also, that it is compatible with connect middleware. 

- [x] Describe Middleware?
    Middleware can get the request and response object, operate on them and when specified trigger some action. Examples of this are logging, validating login and security.
